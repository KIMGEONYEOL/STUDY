...
<div style="float:left;border:1px solid navy;padding:5;margin:5px;margin-left:150px;">
	<h4>새로운 공지사항</h4>
...
<div style="float:left;border:1px solid navy;padding:5;margin:5px;margin-left:50px;">
	<h4>인기 게시글</h4>

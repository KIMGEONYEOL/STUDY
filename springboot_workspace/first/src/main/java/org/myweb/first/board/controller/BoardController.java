...
public class BoardController {
	...
	public String moveBoardUpdatePage(@RequestParam("bnum") int boardNum, @RequestParam("page") int currentPage,
									  Model model) {
	...
	public ModelAndView boardDetailMethod(
		...
		ArrayList<Reply> replyList = replyService.selectReplyList(boardNum);
...
//	}
	...
	public ModelAndView boardSearchWriterMethod(
			...
			@RequestParam("keyword") String keyword,
			@RequestParam(name = "page", required = false) String page,
			@RequestParam(name = "limit", required = false) String slimit, Pageable pageable) {

...
public class NoticeEntity {
    ...
    public void prePersist(){
        noticeDate = new java.sql.Date(System.currentTimeMillis());  //현재 날짜 시간 적용
        // 공지사항 중요도 종료 날짜를 자동으로 등록날짜 기준 3일 뒤로 지정한다면
        impEndDate = new java.sql.Date(System.currentTimeMillis() + (1000 * 60 * 60 * 24 * 3));
    }

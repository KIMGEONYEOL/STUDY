...
public class TestBookManagerMap {
	...
	public static void main(String[] args) {
		...
		do{
			...
			switch(no){
			case 1:	bManager.putBook(inputBook());	break;
			case 2:	bManager.printBookMap(bManager.sortedBookMap());	break;
			case 3:	bManager.removeBook(bManager.searchBook(inputBookTitle()));	break;

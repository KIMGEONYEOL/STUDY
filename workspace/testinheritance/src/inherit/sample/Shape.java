...
// 자바는 클래스 간의 상속에는 단일 상속만 허용함 : 부모 클래스 1개 상속
...
public class Shape extends Point/* , String */ implements Draw {
	...
	public Shape() {
		...
		super(); // 부모의 기본생성자 실행함, 반드시 첫줄에 기입해야함.
	...
	public Shape(double x, double y, double area, double perimeter) {
		...
		System.out.println("Shape 매개변수 있는 4개의 생성자 this : " + this.hashCode());
//		this.x = x; // 같은 주소위치의 Shape 개체 안에 있지만 private 이므로 접근 못함
//		this.y = y;
		this.area = area;
		this.perimeter = perimeter;
	}
	...
	public String toString() {
		// 후손 메서드 안에서 이름이 같은 부모 메서드를 실행하려면 
		// super.부모메서드명() 으로 표기하면 됨
